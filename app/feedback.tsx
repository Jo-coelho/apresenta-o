  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.stepText}>10 de 10</Text>
      </View>
      ...
      <View style={styles.progressBar}>
        {Array.from({ length: 10 }).map((_, index) => (
          <View
            key={index}
            style={index < 10 ? styles.progressActive : styles.progressInactive}
          />
        ))}
      </View>

      <Text style={styles.question}>Deseja Receber Feedback?</Text>
      ...
      >
        <Link href="/" style={styles.nextButtonText}>FINALIZAR</Link>
      </TouchableOpacity>

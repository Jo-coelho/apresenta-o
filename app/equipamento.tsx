  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.stepText}>7 de 10</Text>
      </View>
      ...
      <View style={styles.progressBar}>
        {Array.from({ length: 10 }).map((_, index) => (
          <View
            key={index}
            style={index < 7 ? styles.progressActive : styles.progressInactive}
          />
        ))}
      </View>

      <Text style={styles.question}>Quais Equipamentos Você Possui?</Text>
      ...
      >
        <Link href="/tempo_treino" style={styles.nextButtonText}>PRÓXIMO</Link>
      </TouchableOpacity>
